...
public class CropData implements Serializable {
    ...
    public int hashCode() {
        ...
        hash = 11 * hash + this.cropYield;
        hash = 11 * hash + this.wheatInStore;
        hash = 11 * hash + this.numberWhoDied;
        hash = 11 * hash + this.newPeople;
        hash = 11 * hash + this.harvest;
        hash = 11 * hash + this.harvestAfterOffering;
        hash = 11 * hash + this.offering;
        hash = 11 * hash + this.offeringBushels;
        hash = 11 * hash + this.peopleFed;
        hash = 11 * hash + this.acresPlanted;
        hash = 11 * hash + this.numStarved;
        hash = 11 * hash + this.eatenByRats;
        hash = 11 * hash + this.wheatForPeople;
        return hash;
    }
    ...
    public String toString() {
        return "CropData{" + "year=" + year + ", population=" + population + 
                ...
                harvest + ", harvestAfterOffering=" + harvestAfterOffering + 
                ", offering=" + offering + ", offeringBushels=" + 
                offeringBushels + ", peopleFed=" + peopleFed + 
                ", acresPlanted=" + acresPlanted + ", numStarved=" + 
